package com.pchdesigns.bleconnect;
...
// Change parent class of MainActivity from Activity to ActionBarActivity as
// per instructions for using the appcompat library v21 for Material Design
